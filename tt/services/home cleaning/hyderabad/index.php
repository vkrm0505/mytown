...
$q1="SELECT * FROM workers where type='house cleaning' ORDER BY name ASC";
$res = $con->query($q1);
...
<head>
    ...
    <meta name="title"
          content="Home Cleaning | My Town Home-Services Household services">
    <meta name="description"
          content="Find best service providers for Full Home Cleaning in Hyderabad. Call Ramukaka ☎ XXX-XXXXXXX or book online.">
    <meta name="keywords"
          content="Full Home Cleaning in Hyderabad, Full Home Cleaning Hyderabad, list of Full Home Cleaning in Hyderabad, Full Home Cleaning list">
    ...
    <title>Home Cleaning Services | My Town Home-Services Household services</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="navbar-header">
                    ...
                    <div class="logo">
                        <a href="../../../index.html" class="navbar-brand"><h2>My Town Home-Services</h2></a>
                    </div>
                    <div class="mlogo">
                ...
                <div class="top-contact">
                    <span class="num"><i class="fa fa-phone"> </i>XXX-XXXXXX </span>
                </div>
...
<section id="main-slider" class="slider">
    ...
    <div class="flexslider">
       ...
       <ul class="slides">
              ...
              <li>
                <img src="../../../main-slider/ramukaka-09.jpg" alt="House Cleaning"/>
            ...
            <li>
                <img class="lazyImage img-responsive"  data-src="../../../comjpeg/ramukaka-06.jpg" alt="Ramukaka Carpenter"/>
...
<script>
    ...
    var check_session = 'Full Home Cleaning';
    if (check_session!='') {
...
<section id="services">
    <div class="service-header">
        <h1 class="text-center">Full Home Cleaning in Hyderabad</h1>
