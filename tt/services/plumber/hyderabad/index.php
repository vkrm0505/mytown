...
$q1="SELECT * FROM workers where type='plumber' ORDER BY name ASC";
$res = $con->query($q1);
...
<head>
    ...
    <meta name="title"
          content="Plumber in Hyderabad | Ramukaka Household services in Hyderabad">
    <meta name="description"
          content="Find best service providers for Plumber in Hyderabad. Call Ramukaka ☎ 040-40405050 or book online.">
    <meta name="keywords"
          content="Plumber in Hyderabad, Plumber Hyderabad, list of Plumber in Hyderabad, Plumber list">
    ...
    <title>Plumber in Hyderabad | Ramukaka Household services in Hyderabad</title>
                   ...
                   <div class="sp-list">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                                <p class="skill"><?php echo $an['type']; ?>&nbsp;&nbsp;
                                       </p>
                            </div>
