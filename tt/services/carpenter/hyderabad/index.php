...
$q1="SELECT * FROM workers where type='carpenter' ORDER BY name ASC";
$res = $con->query($q1);
...
<head>
    ...
    <meta name="title"
          content="Carpenter in Hyderabad | Ramukaka Household services in Hyderabad">
    <meta name="description"
          content="Find best service providers for Carpenter in Hyderabad. Call Ramukaka ☎ 040-40405050 or book online.">
    <meta name="keywords"
          content="Carpenter in Hyderabad, Carpenter Hyderabad, list of Carpenter in Hyderabad, Carpenter list">
    ...
    <title>Carpenter in Hyderabad | Household services in Hyderabad</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="top-contact">
                    <span class="num"><i class="fa fa-phone"> </i>XX-XXXXXXXX </span>
                </div>
                   ...
                   <div class="sp-list">
                        ...
                        <div class="row">
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                                                <p class="skill"><?php echo $an['type']; ?>&nbsp;&nbsp;<a
                                       </p>
                            </div>
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <p class="exp"><?php echo $an['experiance']; ?> years of experience </p>
                            </div>

                            <div class="col-md-3 col-sm-6 col-xs-12 ele-align">
                                <div id="stars-existing" class="starrr" data-rating="<?php echo $an['rating']; ?>"></div>
                            </div>
                        </div>
